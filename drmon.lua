...
function update()
    while true do
        ...
        f.draw_text_lr(mon, 2, 4, 1, "Generation", f.format_int(ri.generationRate) .. " rf/t", colors.white,
        ...
        f.draw_text_lr(mon, 2, 6, 1, "Temperature", f.format_int(ri.temperature) .. "C", colors.white, tempColor,
            colors.black)

        f.draw_text_lr(mon, 2, 7, 1, "Output Gate", f.format_int(fluxgate.getFlow()) .. " rf/t", colors.white,
        ...
        f.draw_text_lr(mon, 2, 9, 1, "Input Gate", f.format_int(inputfluxgate.getFlow()) .. " rf/t", colors.white,
            colors.blue, colors.black)
        ...
        if autoInputGate == 1 then
            f.draw_text_lr(mon, 2, 14, 1, "Field Strength T:" .. targetStrength, fieldPercent .. "%", colors.white,
        ...
        if ri.status == "warming_up" and finallycharged == 0 and ri.temperature > 2000 and ri.temperature <
            safeTemperature then
            finallycharged = 1
        end
